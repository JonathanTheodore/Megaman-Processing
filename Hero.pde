...
class Hero
{
  ...
  void jumping(){ //adjust Y values for different platforms. 
  //Possibly add if statements to detect y values of new platforms for megaman to run on?
 ...
 /* void shooting(){ //currently does nothing, maybe use for adding the bullet animations
    if (shootState == "shoot"){
    fill(255,0,0);
      ellipse(mmX,mmY, 200, 70);
    }
  }*/
